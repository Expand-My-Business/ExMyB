//Multiple selectpicker for select > option
                    ...
                    for(var j in temp){
                        ...
                        ttrow = `
                                  <tr>
                                      ...
                                      <td class="cell">
                                          <input name="l2_${new_id}_l3_${temp[j]['id']}_minprice" id="min_price_default" type="number" class="form-control  border-sm">
                                      </td>
                                      <td class="cell">
                                          <input name="l2_${new_id}_l3_${temp[j]['id']}_maxprice" id="max_price_default" type="number" class="form-control  border-sm">
                                      </td>
                                  </tr>
...
$(document).ready(function(){
    var os_trIndex = 1;
        ...
        var os_maxprice = 1; */
        var tr_remove;
    $('.service-form').on('click','#add-service',function(){
        
        $("#custom-tbody").append(
        `<tr id="ctr_${++os_trIndex}">
            <td class="cell"><input name="customservice" id="customservice_${os_trIndex}"  type="text" class="form-control border-sm" required></td>
            <td class="cell"><input name="minPriceDefault" id="min_price_${os_trIndex}" type="number" class="form-control border-sm"  required></td>
            <td class="cell"><input name="maxPriceDefault" id="max_price_${os_trIndex}" type="number" class="form-control border-sm"  required></td>
...
//Get max and min deafult price and set it to the child input min and max price.
...
$(document).ready(function(){
  ...
  $().focus(function(){
    ...
    var getDefMinVal = $(`input[name="l2_${new_id}_minprice"]`).val();
    // var minval = $(getDefMinVal).val();
